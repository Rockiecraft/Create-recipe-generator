...
function downloadRecipeJson() {
  ...
  try {
    ...
    let sourceName = '';
    if (typeof activeRecipeId !== 'undefined' && activeRecipeId
      && typeof recipesDatabase !== 'undefined' && recipesDatabase[activeRecipeId]) {
      sourceName = recipesDatabase[activeRecipeId].name || '';
    }
    if (!sourceName.trim()) {
      const titleInput = document.getElementById('recipeTitle');
      sourceName = titleInput ? titleInput.value : '';
    }
